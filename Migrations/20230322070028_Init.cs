        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstitutionUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InstitutionPrimaryColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LimitBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transactions", x => new { x.Id, x.AccountId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Generateds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Generateds_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Generateds_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Generateds_AccountId",
                table: "Generateds",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Generateds_ScheduleId",
                table: "Generateds",
                column: "ScheduleId");
